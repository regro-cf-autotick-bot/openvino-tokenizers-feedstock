About openvino-tokenizers-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/openvino-tokenizers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openvino-tokenizers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libopenvino-tokenizers openvino-tokenizers
# for installing globally
pixi global install libopenvino-tokenizers openvino-tokenizers
```
...
It is possible to list all of the versions of `libopenvino-tokenizers` available on your platform:
...
```
pixi search libopenvino-tokenizers --channel conda-forge
```
